...
icon: "book"
description: "Essential terms and concepts you need to know to use AskHannah effectively"
---

Understanding these terms will help you navigate AskHannah more easily:
...
AskHannah's built-in workflow platform, similar to Zapier/Make. It lets you connect triggers (like "call ended") to actions (like "send an email" or "update a Google Sheet") without writing code.
...
A method to connect your existing phone system or VOIP provider with AskHannah without renting new numbers.
