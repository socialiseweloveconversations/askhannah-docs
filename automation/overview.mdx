...
description: "Learn about AskHannah's built-in automation engine for creating workflows without coding"
---
...
AskHannah includes an internal automation engine (similar to Zapier or Make) that lets you build flows—no coding required. For instance:
...
- **Triggers**: Events inside AskHannah (e.g., "call ended," "inbound call context injection").
