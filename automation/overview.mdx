...
description: "Learn about Autocalls.ai's built-in automation engine for creating workflows without coding"
---
...
Autocalls.ai includes an internal automation engine (similar to Zapier or Make) that lets you build flows—no coding required. For instance:
...
- **Triggers**: Events inside Autocalls.ai (e.g., "call ended," "inbound call context injection").
