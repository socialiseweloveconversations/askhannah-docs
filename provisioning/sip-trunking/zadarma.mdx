...
4. Click on external services and then check the option for SIP URI.
  ...
  Add ```sip:extension@5wed79aeavr.sip.livekit.cloud ``` (this is AskHannah SIP server address) .
...
## Step 2: Import numbers to AskHannah

You need to import to AskHannah.

1. Go to your AskHannah dashboard
...
3. Click “Integrate SIP trunk”
   ...
   <Frame>
     <img
       ...
       alt="Import numbers to AskHannah"
     />
   </Frame>
...
{/* - If you opted for auth route select Username and password.
   ...
   <Frame>
     <img
       ...
       alt="Twillio AskHannah Credentials Auth Type"
     />
   </Frame> */}
...
- Add the **IPs** from **Zadarma** (Step 1).
   ...
   <Frame>
     <img
       ...
       alt="Twillio AskHannah Credentials IP Type"
     />
   </Frame> 
...
7. Select the country of where your SIP trunk is located. 
    ...
    <Frame>
      <img
        ...
        alt="Twillio AskHannah SIP Country"
      />
    </Frame>
