...
The AskHannah API uses API keys to authenticate requests. You need to include your API key in the header of each request you make to the API.

## Obtaining an API Key

To obtain an API key:

1. Log in to your AskHannah account at [https://app.askhannah.be](https://app.askhannah.be)
...
```bash
curl -X GET "https://app.askhannah.be/api/user/campaigns" \
