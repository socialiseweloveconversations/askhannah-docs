---
title: "AskHannah Tool"
icon: "phone"
description: "Learn how to use AskHannah triggers and actions in your AI calling flows"
---

# AskHannah Tool

The AskHannah tool is the core component that connects your AI calling system with automation flows. It enables real-time data exchange between your AI assistants and business systems, allowing for personalized conversations and automated follow-ups.

<Note>
  You can find the AskHannah tool prominently displayed at the top of the
...
![AskHannah Call Ended Trigger](/resources/autocalls-trigger.jpg)
...
![AskHannah Action](/resources/autocalls-action.jpg)
