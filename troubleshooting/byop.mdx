...
description: "Learn how to use your existing phone numbers or Twilio account with AskHannah through SIP integration or Caller ID verification"
---
...
- Inbound & outbound will flow through your existing lines, but still utilize AskHannah's AI.
...
- Meanwhile, you can have the best of both worlds by provisioning Twilio-based numbers through AskHannah or using a custom approach.
