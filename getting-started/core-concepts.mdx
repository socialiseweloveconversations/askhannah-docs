...
title: "Core Concepts"
icon: "lightbulb"
description: "Learn the fundamental building blocks of AskHannah, including system prompts, voices, and AI assistants"
---

Welcome to the fundamentals of AskHannah. Here, we explore the essential building blocks that you need to understand before configuring your AI assistant and calls.
...
- AskHannah integrates with **ElevenLabs** voices for natural-sounding speech.
